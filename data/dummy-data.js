...
// 🧠 Helper: automatically proxy external images through images.weserv.nl
const proxy = (url) =>
...
export const CATEGORIES = [
  ...
  new Category("c9", "French", "#ffc7ff"),
  new Category("c10", "Summer", "#47fced"),
  new Category("c11", "Afgani", "#5597eeff"),
];
...
export const MEALS = [
  ...
  new Meal(
    ...
    [
      ...
      "Leave bowl above the hot (not simmering) water to keep chocolate warm while you whip the egg whites.",
      "Place 2 egg whites in a mixing bowl; add cream of tartar. Whisk until mixture begins to thicken and a drizzle from the whisk stays on the surface about 1 second before disappearing into the mix.",
      "Add sugar gradually and whisk until mixture holds soft peaks.",
      "Gently fold egg whites into the chocolate mixture.",
      "Divide mixture between prepared ramekins and bake 12–15 minutes until puffed.",
    ],
    true,
    false,
    true,
